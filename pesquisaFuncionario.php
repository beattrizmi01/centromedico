		...
		<div class="area-geral">
			...
			<div class="apaga-consulta opacity0">
				<div class="txt-cabecalho alinha-central">
					<p>Tem certeza que deseja apagar está funcionário?</p>
				</div>
				...
				<div class="txt-apagar">
					...
					<div class="btnApagar btnContainer alinha-central"><p>Apagar</p></div>
				</div>
			</div>
				...
				<table id="tabela1" class="display tabelaMedico tabelaExame	tabelaMaior" style="width:100%">
				 	<thead>
			            <tr>
				 			...
				 			<th>Telefone</th>
				 			<th>Cargo</th>
				 			<th>Editar funcionário</th>
				 			<th>Apagar funcionário</th>
				 		</tr>
			        </thead>
			        <tbody>
			            ...
			            <tr>
				 			...
				 			<td><?php if($linha['cargo_idcargo'] == 3){
                                                           echo "Gerente";
                                                        }else if($linha['cargo_idcargo'] == 2){
                                                               echo "Sub Gerente";
                                                        }else{
                                                               echo "Atendente";  
                                                        } ?>
				 			...
				 			<td>
                                                            <?php if ($editar == 0){?>
                                                            <a href="editar-Funcionario.php?id=<?php echo $linha['idFuncionario']?>"><i class="fas fa-edit"></i></a>
                                                         <?php } ?>
                                                        </td>
				 			<td>
                                                            <?php if ($editar == 0){?>
                                                            <i class="close op-close fas fa-trash-alt"></i></td>
                                                        <?php } ?>
				 		</tr>
