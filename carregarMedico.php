				 ...
				 <div class="container-info-paciente alinha-central">
				 	...
				 	<div class="botoes-container">
				 		...
				 		<div class="container-apagar containerSome">
							<p class="optionSome txtApagar">Deseja apagar este Medico do Sistema?</p>
					 		<div class="dangerZone">
                                                            <div class="btn btn-red btnExcluir optionSome"><a href="deletarMedico.php?id=<?php echo $id?>">Apagar</a></div>
						 	<div class="btn  btn-red btnApagar">Apagar Medico</div>
