...
<head>
  ...
  echo $id;
        require_once('buscarEspecialidade.php');
				 ...
				 <header class="header-cadastro">
				 	<div class="">
				 		<p></p>
                            ...
                            <form class="area-form" action="editarEspecialidade.php" >
				 	<div class="input-area ">
				 		...
				 		<p>Codigo do procedimento</p>
                                                <input required="" type="text" name="id_especialidade" value="<?php echo $linha['id_especialidade']?>">
				 	</div>
				 	<div class="input-area">
				 		<p>Nome do procedimento</p>
                                                <input required="" type="text" name="descricao" value="<?php echo $linha['descricao']?>">
				 	</div>
                                     <div class="input-area">
				 		<p>Valor do procedimento</p>
                                                <input required="" type="text" name="valor" id="preco" value="<?php echo $linha['valor'] ?>">
				 	</div>
