				 ...
				 <header class="header-cadastro">
				 	<div class="">
				 		<p></p>
                            ...
                            <form class="area-form" action="cadastarMedico.php">
				 	...
				 	<div class="input-area select">
				 		...
				 		<div class="flex">
                                                    ...
                                                    <select class="input-maior campoSelect" name="especilidade">
                                                            <?php 
                                                                if ($total){do {
                                                               ?>
				 	...
				 	<div class="area-btn alinha-central">
				 		...
				 		<a href="pesquisaMedico.php"><div  class="btn btn-gray">Pesquisar</div></a>
				 	</div>
				 </form>
			</div>
		</div>
