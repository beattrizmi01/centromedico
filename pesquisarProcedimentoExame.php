...
<head>
   ...
   $editar = 0;
    if($acesso==1){
        ...
        require_once('./buscarProcedimentoExame.php');
			        ...
			        <tbody>
			            ...
			            <tr>
				 			<td><?php echo $linha['descricao_tipo_exame']?></td>
                                                        <td>
                                                            <?php if ($editar == 0){?>
                                                            <a href="editarProcedimentoExame.php?id= <?php echo $linha['id_tipo_exame']?>"><i class="fas fa-edit"></i></a>
                                                            <?php } ?>
                                                        </td>
                                                        
                                                        <td>
                                                          <?php if ($editar == 0){?>  
                                                            <a href="excluirExame.php?id=<?php echo $linha ['id_tipo_exame'] ?>"><i class="close op-close fas fa-trash-alt"></i></a>
                                                        <?php } ?>
                                                        </td>
