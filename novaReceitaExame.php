...
<head>
    ...
    if($acesso== null){
      ...
      echo $id;
       ...
       require_once('buscarNovaReceitaExame.php');
			...
			<div class="card-cadastro cadastroPaciente">
				 ...
				 <div class="info-pagamento">
				 	...
				 	<div class="pagamento-area">
				 		...
				 		<div class="div-info">
				 			<p>R$ <span  class="valorProcedimento"><?php echo $linha['valor_exame']?></span></p>
				 		</div>
				 	</div>
				 </div>
                            <form class="area-form" action="RegistarPagamentoExame.php">
				 	...
				 	<div class="input-area">
				 		<p>Formas de pagamento</p>
                                                <select class="pagamento input-maior campoSelect"  name="opcao" onchange="Mudar();">
				 	...
				 	<div class="input-area container-moeda someDinheiro">
				 		...
				 		<div class="area-troco">
				 			...
				 			<input  onchange="MudaTroco()" class="valor" type="number" name="">
				 		</div>
				 	</div>
				 	...
				 	<div class="input-area">
				 		<p>Data</p>
                                              <?php ?>
                                                <input type="date" name="" placeholder="Endereço" value="<?php  $d = date("Y-m-d"); echo$d; $linha['data_exame']?>">
				 	</div>
				 	<div class="input-area">
				 	</div>
				 	<div class="area-btn alinha-central">
                                            <button type="submit" class="btn btn-blue">Finalizar</button>
				 		<a href="atendente-editarExame.php">
