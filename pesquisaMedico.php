		...
		<div class="area-geral">
			...
			<!---<div class="apaga-consulta opacity0">
				<div class="txt-cabecalho alinha-central">
					<p>Tem certeza que deseja apagar está médico?</p>
				</div>
				...
				<table id="tabela1" class="display tabelaMedico tabelaExame	tabelaMaior" style="width:100%">
			        ...
			        <tbody>
			            ...
			            <tr>
				 			...
				 			<td><a href="editarMedico.php?id=<?php echo $linha['id_medico']?>"><i class="fas fa-edit"></i></a></td>
				 			<td>
				 				<a href="carregarMedico.php?id=<?php echo $linha['id_medico'] ?>&&medico=<?php echo $linha['nome']?> && especialidade=<?php echo $linha['descricao'] ?>"><i class="close op-close fas fa-trash-alt"></i></a></td>
				 		</tr>
