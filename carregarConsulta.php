...
<head>
  ...
  $paciente = filter_input(INPUT_GET, 'paciente');
  $procedimento = filter_input(INPUT_GET, 'procedimento');
 $dataE = filter_input(INPUT_GET, 'data');
			...
			<div class="card-cadastro card-cadastro-maior cadastroPaciente">
				 <header>
				 	<div class="area-texto">
				 		<p>Apagar Procedimento</p>
				 	</div>
				 </header>
				 <div class="container-info-paciente alinha-central">
				 	<div class="info-paciente">
                                            
				 		<h4>Paciente:   <?php echo $paciente ?></h4>
                                                <p>Codigo:   <?php echo $id ?></p>
                                                <p>Procedimento:  <?php echo $procedimento ?></p>
                                                  <p>Data:   <?php echo $dataE ?></p>
				 		...
				 		<div class="container-apagar containerSome">
							<p class="optionSome txtApagar">Deseja apagar este procedinto do Sistema?</p>
					 		<div class="dangerZone">
                                                            <div class="btn btn-red btnExcluir optionSome"><a href="deletarConsulta.php?id=<?php echo $id?>">Apagar</a></div>
						 	<div class="btn  btn-red btnApagar">Apagar Procedimento</div>
						 <?php } ?>
