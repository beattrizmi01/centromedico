				 ...
				 <header class="header-cadastro">
				 	<div class="">
				 		<p></p>
                            ...
                            <form class="area-form" action="cadastroFuncionario.php">
				 	<div class="input-area">
				 		<p>Nome completo</p>
				 		<input required="" type="text" name="nome" required="">
				 	</div>
				 	<div class="input-area">
				 		<p>CPF</p>
				 		<input required="" type="text" name="cpf" required="" id="cpf">
				 	</div>
				 	<div class="input-area">
				 		<p>Endereço</p>
				 		<input required="" type="text" name="endereco" required="">
				 	</div>
				 	<div class="input-area">
				 		<p>Telefone</p>
				 		<input required="" type="text" name="telefone" required="" id="telefone">
				 	</div>
				 	<div class="input-area ">
				 		<p>Cargo</p>
                                                <select  name="cargo" class="campoSelect input-maior">
				 	...
				 	<div class="input-area">
				 		<p>Email</p>
                                                <input required="" type="email" name="email" required="" id="email" >
				 	</div>
                                       <div class="input-area">					
							<p>Senha</p>
				 	...
				 	<div class="area-btn alinha-central">
				 		...
				 		<a href="pesquisaFuncionario.php"><div  class="btn btn-gray">Pesquisar</div></a>
				 	</div>
				 </form>
			</div>
		</div>
