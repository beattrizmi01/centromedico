...
<head>
  ...
  $funcionario = filter_input(INPUT_GET, 'f');
  
  $pagamanto = filter_input(INPUT_GET, 'p');
  
  
  $dataP = filter_input(INPUT_GET, 'd');
  
  $tipo =  filter_input(INPUT_GET, 't');
    ?>
			...
			<div class="card-cadastro card-cadastro-maior cadastroPaciente">
				 <header>
				 	<div class="area-texto">
				 		<p>Pgamento Detalhado</p>
				 	</div>
				 </header>
				 <div class="container-info-paciente alinha-central">
				 	<div class="info-paciente">
				 		<h4>Funcionario(a): <?php echo $funcionario ?></h4>
                                                   <p>Procedimento: <?php echo $tipo ?></p>
                                                 <p>Forma de Pagamento: <?php echo $pagamanto ?></p>
                                                <p>Data do Pagamento: <?php echo $dataP ?></p>
