...
<head>
    ...
    echo $id;
      require_once('./buscarEstornoExame.php');
			...
			<div class="card-cadastro card-cadastro-maior cadastroPaciente">
				 ...
				 <div class="container-info-paciente alinha-central">
				 	<div class="info-paciente">
				 		<h4>Paciente <?php echo $linha['nomePaciente'] ?></h4>
                                              
				 		<p> <?php echo $linha['descricao_tipo_exame'] ?></p>
				 		
				 		<p><?php echo $linha['data_exame'] ?></p>
				 		<p><?php echo $linha['turno'] ?></p>
                                                <p>Pagamento 0<?php echo $linha['id_pagamento_exame'] ?></p>
                                                <p>Valor R$ <?php echo $linha['valor_exame'] ?></p>
				 	</div>
				 	<div class="botoes-container">
				 		<div class="container-apagar containerSome">
							<p class="optionSome txtApagar">Deseja estornar o valor do exame?</p>
					 		<div class="dangerZone">
                                                            <div class="btn btn-red btnExcluir optionSome"><a href="<?php echo "estornarExame.php?id=" . $linha["id_pagamento_exame"] ?>">Estornar</a></div>
						 		<div class="btn  btn-red btnApagar">Estornar Exame</div>
